import{f as n,b,u as y,j as e,R as re,T as P,a as v,e as h,U as se,V as oe,W as ae,X as Q,Y as ee,Z as ce,s as D,L as le,F as I,_ as de}from"./index-16770aff.js";import{n as B}from"./emotion-styled.browser.esm-4a7844a1.js";import{c as pe}from"./emotion-react.browser.esm-8f94eaf3.js";import{P as xe}from"./PageAnimatedWrapper-4d0ce46b.js";import{B as he}from"./Button-d217e481.js";import{g as ue}from"./productsHelpers-95529711.js";const ge=n.ul`
  display: flex;
  gap: 28px;
  margin-bottom: 48px;
...
`,ze=n.p`
  ...
  color: rgba(239, 237, 232, 0.4);
`,Ie="/power-pulse-fe/assets/0-default-fa91a1ec.jpg",U=({exercisesItem:t})=>{const{name:i,filter:r,imgURL:s}=t,a=y(),o=l=>{a(P(l))},c=l=>l.slice(0,1).toUpperCase()+l.slice(1);return e.jsxs(ke,{onClick:()=>o(i),children:[e.jsx(Ce,{src:s||Ie,alt:i}),e.jsxs(Ee,{children:[e.jsx(Pe,{children:c(i)}),e.jsx(ze,{children:r})]})]})},A=n.div`
  display: flex;
  flex-direction: column;
